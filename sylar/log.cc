...
#str, [](const std::string &fmt) { return FormatItem::ptr(new C(fmt)); } \
          ...
          XX(F, FirbeIdFormatItem),  XX(N, ThreadNameFormatItem),
#undef XX
      };
...
struct LogDefine {
  ...
  bool operator<(const LogDefine &oth) { return name < oth.name; }
